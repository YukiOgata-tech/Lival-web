...
import { Code, Brain, Users, BookOpen, Palette, BarChart3, ChevronDown } from 'lucide-react'
...
function RoleCard({ role, index }: { role: typeof teamRoles[0], index: number }) {
      ...
      <div className="p-5 sm:p-6 cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <div className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r ${role.color} rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300`}>
