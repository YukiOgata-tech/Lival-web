        ...
        >
          ...
          >
            <div className="relative">
              <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mb-4">
                <Brain className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white" />
              </div>
              <motion.div
                animate={{ rotate: 360 }}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                className="absolute -top-2 -right-2 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-yellow-400 rounded-full flex items-center justify-center"
              >
                <Sparkles className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-gray-900" />
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl mb-3 sm:mb-4 md:mb-6 text-white leading-tight">
            ...
            <p className="text-sm sm:text-base md:text-xl lg:text-2xl text-gray-300 mb-4 sm:mb-6 md:mb-8 leading-relaxed max-w-3xl mx-auto font-soft px-2 sm:px-0">
            ...
            {/* Stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 md:gap-6 mt-6 sm:mt-8 md:mt-12">
              {[
