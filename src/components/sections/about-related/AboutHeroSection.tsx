        ...
        >
          ...
          >
            <div className="relative">
              <div className="w-14 h-14 sm:w-16 md:w-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center">
                <Brain className="w-7 h-7 sm:w-8 md:w-10 text-white" />
              </div>
              <motion.div
                animate={{ rotate: 360 }}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                className="absolute -top-1 -right-1 w-5 h-5 sm:w-6 md:w-7 bg-yellow-400 rounded-full flex items-center justify-center"
              >
                <Sparkles className="w-2.5 h-2.5 sm:w-3 md:w-3.5 text-gray-900" />
              </motion.div>
            </div>
          </motion.div>
