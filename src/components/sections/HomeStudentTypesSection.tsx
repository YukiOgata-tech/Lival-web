...
// 学習者タイプ
const studentTypes = [
  { id: 'strategist', name: '戦略家', description: '論理的思考で効率を重視', icon: '🎯', image: '/images/li-kun_val-chan/val-chan-ST-1.png', color: 'from-blue-400 to-blue-600' },
  { id: 'explorer', name: '探求家', description: '興味と好奇心で発見を楽しむ', icon: '🔍', image: '/images/li-kun_val-chan/li-kun-EX-1.png', color: 'from-purple-400 to-purple-600' },
  { id: 'achiever', name: '努力家', description: '継続的な努力で成果を積み上げ', icon: '💪', image: '/images/li-kun_val-chan/li-kun-AC-1.png', color: 'from-green-400 to-green-600' },
  { id: 'challenger', name: '挑戦家', description: '競争を楽しみ限界に挑戦', icon: '⚡', image: '/images/li-kun_val-chan/li-kun-CH-1.png', color: 'from-red-400 to-red-600' },
  { id: 'companion', name: '伴走者', description: '協力と共感を大切にする', icon: '🤝', image: '/images/li-kun_val-chan/val-chan-SP-1.png', color: 'from-pink-400 to-pink-600' },
  { id: 'efficiency', name: '効率家', description: '最短ルートで結果を追求', icon: '🚀', image: '/images/li-kun_val-chan/li-kun-OP-1.jpg', color: 'from-orange-400 to-orange-600' }
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
          {studentTypes.map((type, index) => (
            <Link href={`/diagnosis/types#${type.id}`} key={type.name} className="block h-full">
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer h-full"
              >
