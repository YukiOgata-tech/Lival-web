      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-2 md:mb-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <stat.icon className="w-5 h-5 md:w-8 md:h-8 text-white" />
              </div>
              <div className="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-1 md:mb-2">
