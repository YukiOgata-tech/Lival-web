        ...
        {[...Array(5)].map((_, i) => (
          <div key={i} className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 animate-pulse">
            <div className="flex items-start gap-2 sm:gap-3">
              <div className="w-10 h-12 sm:w-12 sm:h-16 bg-gray-200 rounded"></div>
    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
        ...
        {showAddButton && (
          ...
          >
            ...
            <span className="sm:inline">記録を追加</span>
          </button>
        )}
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-8 sm:py-12 bg-white rounded-lg border border-gray-200 px-4">
          ...
          <p className="text-gray-500 mb-3 sm:mb-4 text-sm sm:text-base">まだ学習記録がありません</p>
          {showAddButton && (
            <button
              onClick={openCreateModal}
