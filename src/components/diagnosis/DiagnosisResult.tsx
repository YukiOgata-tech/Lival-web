...
export default function DiagnosisResult({
  ...
  return (
    <div className={`space-y-8 ${className}`}>
      ...
      >
        {/* ヘッダー */}
        <div className={`bg-gradient-to-r ${getTypeColor(primaryType.id)} p-8 text-white`}>
          <div className="flex items-center space-x-4 mb-4">
            <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center">
              <PrimaryIcon className="w-8 h-8 text-white" />
            </div>
            <div>
              <h1 className="text-3xl font-bold">{primaryType.displayName}</h1>
              <p className="text-lg opacity-90">{primaryType.scientificName}</p>
            </div>
          </div>
          <p className="text-lg opacity-95">{primaryType.description}</p>
        </div>
                ...
                <AnimatePresence>
                  {expandedSections['scientific'] && (
                    <motion.div
                      ...
                      className="mt-4"
                    >
                      <p className="text-gray-700 leading-relaxed">{detailedInfo.scientificBackground}</p>
              ...
              <div className="bg-green-50 rounded-xl p-6">
                ...
                <AnimatePresence>
                  {expandedSections['learning'] && (
                    ...
                    >
                      <p className="text-gray-700 leading-relaxed">{detailedInfo.learningApproach}</p>
                      
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">動機の源泉</h4>
                        <p className="text-green-700">{detailedInfo.motivationSource}</p>
                      </div>
                      
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">詳細な特徴</h4>
              ...
              <div className="bg-amber-50 rounded-xl p-6">
                ...
                <AnimatePresence>
                  {expandedSections['tips'] && (
                    ...
                    >
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-3">🎯 あなたの強み</h4>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                          {detailedInfo.strengths.map((strength, index) => (
                            <div key={index} className="bg-green-100 px-3 py-2 rounded-lg text-sm text-green-800">
                              {strength}
                            </div>
                          ))}
                        </div>
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-3">📚 効果的な学習方法</h4>
                        <div className="space-y-2">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-3">🌱 成長できる領域</h4>
                        <div className="space-y-2">
      ...
      {showActions && (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link
              href="/dashboard"
              className="flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-6 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105"
            >
            ...
            <motion.button 
              ...
              className={`flex items-center justify-center space-x-2 py-3 px-6 rounded-lg transition-all duration-200 disabled:cursor-not-allowed ${
                downloadSuccess 
              ...
              <AnimatePresence mode="wait">
                {isDownloading ? (
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="w-5 h-5 animate-spin rounded-full border-2 border-gray-300 border-t-gray-700"
                  />
                ) : downloadSuccess ? (
                  <motion.div
                    key="success"
            ...
            <div className="relative">
              <button 
                ...
                disabled={isSharing}
                className="flex items-center justify-center space-x-2 border border-gray-300 text-gray-700 py-3 px-6 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 w-full"
              >
                {isSharing ? (
