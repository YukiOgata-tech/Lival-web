      ...
      <div className="mx-auto max-w-3xl p-3 pb-3">
        ...
        <div className="flex items-end gap-2">
          ...
          <textarea
            ...
            rows={1}
            className="min-h-[40px] flex-1 resize-none text-gray-900 bg-white placeholder:text-gray-400 rounded-md border border-gray-300 p-2 text-base shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
            style={{ fontSize: '16px' }}
          />
          <button
            onClick={send}
